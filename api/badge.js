...
function buildSVG({ online, last_seen }) {
  ...
  <circle cx="28" cy="40" r="6" fill="${color}" class="dot"/>
  ...
  <text x="372" y="34" font-family="'Courier New',monospace" font-size="11" fill="${color}" text-anchor="end" letter-spacing="2">${statusText}</text>
