...
const animationMap = {
    typing:   require('./_typing'),
    fade:     require('./_fade'),
    slide:    require('./_slide'),
    bounce:   require('./_bounce'),
    pulse:    require('./_pulse'),
    blink:    require('./_blink'),
    shake:    require('./_shake'),
    rainbow:  require('./_rainbow'),
    glitch:   require('./_glitch'),
    stroke:   require('./_stroke'),
    wave:     require('./_wave'),
    flip:     require('./_flip'),
    neon:     require('./_neon'),
    matrix:   require('./_matrix'),
    zoom:     require('./_zoom'),
    blur:     require('./_blur'),
    float:    require('./_float'),
    swing:    require('./_swing'),
    pop:      require('./_pop'),
    skew:     require('./_skew'),
};
