const { clamp01, getLineY, buildSequenceOpacity } = require('../../lib/text-animation/_utils');

const animationMap = {
    typing:   require('../../lib/text-animation/_typing'),
    fade:     require('../../lib/text-animation/_fade'),
    slide:    require('../../lib/text-animation/_slide'),
    bounce:   require('../../lib/text-animation/_bounce'),
    pulse:    require('../../lib/text-animation/_pulse'),
    blink:    require('../../lib/text-animation/_blink'),
    shake:    require('../../lib/text-animation/_shake'),
    rainbow:  require('../../lib/text-animation/_rainbow'),
    glitch:   require('../../lib/text-animation/_glitch'),
    stroke:   require('../../lib/text-animation/_stroke'),
    wave:     require('../../lib/text-animation/_wave'),
    flip:     require('../../lib/text-animation/_flip'),
    neon:     require('../../lib/text-animation/_neon'),
    matrix:   require('../../lib/text-animation/_matrix'),
    zoom:     require('../../lib/text-animation/_zoom'),
    blur:     require('../../lib/text-animation/_blur'),
    float:    require('../../lib/text-animation/_float'),
    swing:    require('../../lib/text-animation/_swing'),
    pop:      require('../../lib/text-animation/_pop'),
    skew:     require('../../lib/text-animation/_skew'),
};
